      ...
      (0 until n).map { i =>
        BoomTileAttachParams(
          tileParams = BoomTileParams(
            ...
            dcache = Some(
              DCacheParams(rowBits = 128, nSets=64, nWays=4, nMSHRs=6, nFlshMSHRs=4, nTLBWays=8)
            ),
            icache = Some(
      ...
      (0 until n).map { i =>
        BoomTileAttachParams(
          tileParams = BoomTileParams(
            ...
            dcache = Some(
              DCacheParams(rowBits = 64, nSets=64, nWays=4, nMSHRs=2, nFlshMSHRs=4, nTLBWays=8)
            ),
            icache = Some(
              ICacheParams(rowBits = 64, nSets=64, nWays=4, fetchBytes=2*4)
            ),
      ...
      (0 until n).map { i =>
        BoomTileAttachParams(
          tileParams = BoomTileParams(
            ...
            dcache = Some(
              DCacheParams(rowBits = 128, nSets=64, nWays=8, nMSHRs=4, nFlshMSHRs=4, nTLBWays=16)
            ),
            icache = Some(
              ICacheParams(rowBits = 128, nSets=64, nWays=8, fetchBytes=4*4)
            ),
      ...
      (0 until n).map { i =>
        BoomTileAttachParams(
          tileParams = BoomTileParams(
            ...
            dcache = Some(
              DCacheParams(rowBits = 128, nSets=64, nWays=8, nMSHRs=8, nFlshMSHRs=8, nTLBWays=32)
            ),
            icache = Some(
              ICacheParams(rowBits = 128, nSets=64, nWays=8, fetchBytes=4*4)
            ),
